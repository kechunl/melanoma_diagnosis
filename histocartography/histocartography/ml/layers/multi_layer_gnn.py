...
from .diffpool.model.dgl_layers.gnn import DiffPoolBatchedGraphLayer
...
class MultiLayerGNN(nn.Module):
    ...
    def __init__(
        ...
        **kwargs
        ...
        #     self.layers.append(DiffPoolBatchedGraphLayer(input_dim, assign_dim, input_dim))
    ...
    def forward(self, g, h, with_readout=True):
        ...
        for layer in self.layers:
            h = layer(g, h)
            # if layer.__class__.__name__ == 'DiffPoolBatchedGraphLayer':
            #     g, h = layer(g, h)
            #     continue
            # else:
            #     h = layer(g, h)
